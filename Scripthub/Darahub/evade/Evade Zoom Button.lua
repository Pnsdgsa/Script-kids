...
if unibarLeftFrame:FindFirstChild("Secondary") then
    return
end
...
Secondary.Parent = unibarLeftFrame
Secondary.BackgroundTransparency = 1.000
Secondary.ClipsDescendants = true
Secondary.LayoutOrder = betaButtonLayoutOrder + 2  
...
local largeButtonSize = UDim2.new(0, 100, 0, 44)  -- Adjusted for shorter text
local smallIconSpotSize = UDim2.new(0, 36, 1, -8)
local largeIconSpotSize = UDim2.new(0, 92, 1, -8)  -- Adjusted for shorter text
local smallLabelSize = UDim2.new(0, 0, 1, 0)
local largeLabelSize = UDim2.new(0, 45, 1, 0)  -- Adjusted for "Zoom"
