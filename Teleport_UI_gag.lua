...
if cosmeticsCraftingTextLabel and cosmeticsCraftingTextLabel:IsA("TextLabel") then
    ...
    cosmeticsCraftingTextLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- White text
else
    -- Create Txt TextLabel if it doesn't exist
    cosmeticsCraftingTextLabel = Instance.new("TextLabel")
    cosmeticsCraftingTextLabel.Name = "Txt"
    cosmeticsCraftingTextLabel.Text = "COSM/CRAFT"
    cosmeticsCraftingTextLabel.Size = UDim2.new(1, 0, 1, 0) -- Full size of parent button
...
eventButton.Size = UDim2.new(0.409559458, 0, 0.98507452, 0)
...
local function teleportPlayer(position)
    if character and character:FindFirstChild("HumanoidRootPart") then
        local yawAngle = math.rad(90)        local targetCFrame = CFrame.new(position) * CFrame.Angles(0, yawAngle, 0)
